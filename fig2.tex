...
\firstcol{1}{$\frac{\textrm{d}P}{\textrm{d}t}$}{figures/F2_mass_production_net_production}{}
...
\othercol{3}{$\frac{\textrm{d}m_{\textrm{t}}}{\textrm{d}P}$}{figures/F2_leaf_area_growth_leaf_fraction}{$\times$}
\othercol{4}{$\frac{\textrm{d}P}{\textrm{d}t}$}{figures/F2_leaf_area_growth_net_production}{}
\rowlabel{(3)}
