...
% By default, we set $r_{\rm r1}=0.8$ and $r_{\rm r2}=10$, implying a relatively rapid transition to reproduction at $H=H_{\rm m}$ (Fig. \ref{fig:S3}).
...
\noindent{\bf Height at maturation, $H_{\rm m}$:}
...
\vspace{1cm}
  ...
  & \multicolumn{9}{l} {Stem area {\color{red} (check)}} \\
  ...
  & \multicolumn{9}{l} {Mass {\color{red} (check, live or total?)}} \\
