...
% Consider Ecol Letters I deas and Perspectives: maximum of 7500 words (main text), and 10 figures, tables or boxes.
...
{\footnotesize  % smaller font, double space
 \begin{doublespace}
  ...
  Variable & Function & Marginal cost & Growth rate & Eq.\\ \hline
  ...
  sapwood area &
    ...
    $\frac{{\rm d}A_{\rm s}}{{\rm d}t}  =\frac{{\rm d}A_{\rm s}}{{\rm d} A_{\rm l}} \, \frac{{\rm d}A_{\rm l}}{{\rm d}t}$ & \eqncounter{eq:a}\\
  bark area &
    $A_{\rm b} = b \, \theta \, A_{\rm l}$ &
    $\frac{{\rm d}A_{\rm b}}{{\rm d} A_{\rm l}} = b \, \theta$ &
    $\frac{{\rm d}A_{\rm b}}{{\rm d}t} = \frac{{\rm d}A_{\rm b}}{{\rm d} A_{\rm l}} \, \frac{{\rm d}A_{\rm l}}{{\rm d}t}$ & \eqncounter{eq:a}\\  \\
...
\vspace{1cm}
  ...
  & \multicolumn{2}{ l } {Sapwood area per leaf} & $ \ud A_{\rm s} / \ud A_{\rm l}$ & - & - & - & - & - \\
  & \multicolumn{2}{ l } {Sapwood turnover} & $k_{\rm s} \, A_{\rm s}$ & - & - & - & - & - \\ \hline
  \\
...
\begin{figure}[ht]
\centering
\includegraphics{main/mass_fraction.pdf}
