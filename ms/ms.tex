...
mass-based relative growth rate is linearly and negatively related to LMA
 \citep{lambers-1992, cornelissen-1996, wright_cross-2000}.
...
\begin{figure}[ht]
\centering
\includegraphics{figure_conceptual.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{growth_light_dia.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{growth_light_mass.pdf}
\caption{\textbf{Traits moderate the responsiveness of growth to changes
...
\begin{figure}[ht]
\centering
\includegraphics{max_leaf_above.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_quantile_examples.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_lma_tradeoff.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_mass_fraction.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_lma_effects_at_diameters.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_lma_effects_at_diameters_relative.pdf}
\caption{\textbf{The expected correlation between leaf-construction cost
...
\begin{figure}[ht]
\centering
\includegraphics{SI_rho_effects_at_diameters.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_rho_effects_at_diameters_relative.pdf}
\caption{\textbf{The expected correlation between stem-construction cost
and relative growth rate changes with plant size.}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_hmat_effects_at_diameters.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics{SI_hmat_effects_at_diameters_relative.pdf}
\caption{\textbf{The expected correlation between maximum height and
