...
\refstepcounter{equation}\label{eq:dbdt_2}
\refstepcounter{equation}\label{eq:dMtdt}
\refstepcounter{equation}\label{eq:daldmt}
\refstepcounter{equation}\label{eq:daldt}
\refstepcounter{equation}\label{eq:dhdt}
\refstepcounter{equation}\label{eq:dast}
\refstepcounter{equation}\label{eq:dDdt}
