...
![**Estimating potential growth rate via quantile regression.**
Example for 4 species. Growth rate estimated at six sizes, by fitting lines within given size intervals. Lines fitted to 99th quantile, but only when n > 500. Except for left-hand panel, estimated points in centre of interval. \label{fS-quantile_examples}](figures/SI_quantile_examples.pdf)
