...
\newcommand{\rowlabel}[1]{
  ...
  \footnotesize {\color{orange!50}\begin{equation}\label{#1}\end{equation}}};
}
...
\defineRow{0}{thisrow}
\rowtitle{Biomass production rate}
...
\defineRow{1}{thisrow}
\rowtitle{Leaf deployment per mass}
...
\othercol{3}{$\frac{{\rm d}M_{{\rm s}}}{{\rm d}A_{{\rm l}}}$}{output/con/darea_leaf_dmass_live_dmass_sapwood_darea_leaf}{+}
...
\othercol{5}{$\frac{{\rm d}M_{{\rm r}}}{{\rm d}A_{{\rm l}}}$}{output/con/darea_leaf_dmass_live_dmass_root_darea_leaf}{$\Bigg)^{-1}$}
 \rowlabel{eq:daldmt}
\defineRow{2}{thisrow}
\rowtitle{Leaf-area growth rate}
...
\defineRow{4}{thisrow}
\rowtitle{Stem-area growth rate}
\firstcol{1}{$\frac{{\rm d}A_{{\rm st}}}{{\rm d}t}$}{output/con/area_stem_dt_area_stem_dt}{$\Bigg($}
\othercol{2}{$\frac{{\rm d}A_{{\rm s}}}{{\rm d}A_{{\rm l}}}$}{output/con/area_stem_dt_darea_sapwood_darea_leaf}{$+$}
...
\defineRow{5}{thisrow}
\rowtitle{Stem-diameter growth rate}
