...
\documentclass[12pt,article,a4paper]{$documentclass$}
...
\hypersetup{breaklinks=true,
            ...
            pdftitle={$title-meta$},
            colorlinks=true,
            urlcolor=$if(urlcolor)$$urlcolor$$else$grey$endif$,
...
\author{$for(author)$\Large $author.name$\vspace{0.05in} \\ \normalsize\emph{$author.affiliation$} \\ \url{$author.email$}\vspace*{0.2in}\\ \and $endfor$}
